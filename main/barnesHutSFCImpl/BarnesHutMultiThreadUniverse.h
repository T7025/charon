...
#ifndef CHARON_BARNESHUTMULTITHREADUNIVERSE_H
#define CHARON_BARNESHUTMULTITHREADUNIVERSE_H


#include "BarnesHutUniverseBase.h"

class BarnesHutMultiThreadUniverse : public BarnesHutUniverseBase {
public:
    BarnesHutMultiThreadUniverse(std::shared_ptr<Settings> settings, std::shared_ptr<spdlog::logger> console);
...
#endif //CHARON_BARNESHUTMULTITHREADUNIVERSE_H
